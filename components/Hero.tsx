      ...
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        <div className="max-w-3xl">
          ...
          <h1 className="font-heading font-bold text-3xl sm:text-4xl lg:text-5xl xl:text-6xl uppercase leading-tight mb-5">
            <span className="text-white">Vizibilitate </span>
            <span className="text-brand-red">Garantată</span>
            <br />
            <span className="text-white">Pentru </span>
            <span className="text-brand-red">Mașina Ta!</span>
          </h1>

          {/* Subtitle */}
          <p className="font-body text-brand-mid-gray text-base sm:text-lg mb-3 max-w-2xl">
            Reparații rapide și înlocuiri de parbrize pentru toate tipurile de autovehicule.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-10">
            <a href="#contact" className="btn-primary w-full sm:w-auto text-sm sm:text-base px-6 py-4">
              Programează Acum
            </a>
            <a href={`tel:${SITE_CONFIG.phonesRaw[0]}`} className="btn-secondary w-full sm:w-auto text-sm sm:text-base px-6 py-4">
