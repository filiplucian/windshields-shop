const testimonials = [
  ...
  },
  {
    ...
    location: 'Radauti',
    rating: 5,
    text: 'Imi intra apă in mașină, dar nu a mai fost nevoie de lipire parbriz. Problema a fost diagnosticată corect și am primit un serviciu de calitate.',
  },
]
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-14'>
          ...
          <p className='section-subtitle'>
            Peste 1.000 de clienți mulțumiți în Rădăuți și împrejurimi.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-6'>
          {testimonials.map(t => (
            <div key={t.name} className='card'>
              ...
              <p className='font-body text-brand-mid-gray text-sm leading-relaxed mb-5 italic'>
                &ldquo;{t.text}&rdquo;
              </p>
              <div className='flex items-center gap-3'>
                ...
                <div>
                  ...
                  <p className='font-body text-brand-mid-gray text-xs'>
                    {t.location}
                  </p>
                </div>
              </div>
