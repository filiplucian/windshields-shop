        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 mb-10'>
          ...
          <div className='sm:col-span-2 lg:col-span-1'>
            ...
            <p className='font-body text-brand-mid-gray text-sm leading-relaxed mb-4'>
              Ca să vezi bine. Reparații și înlocuiri de parbrize rapide și
              profesionale în Rădăuți.
            </p>
            <div className='flex flex-wrap items-center gap-3'>
              {SITE_CONFIG.personality.map((t, i) => (
                <div key={t} className='flex items-center gap-3'>
                  <span className='font-heading font-bold text-brand-red text-xs uppercase tracking-widest'>
                    {t}
                  </span>
          ...
          {/* Contact */}
          <div>
            <h4 className='font-heading font-bold text-white uppercase tracking-wide text-sm mb-4'>
              Contact
            </h4>
                ...
                <li
                  ...
                  {area === 'Rădăuți' ? (
                    <span className='font-bold text-brand-red'>
                      {area}{' '}
                      <span className='font-normal text-brand-red/70 text-xs'>
                        (sediu)
                      </span>
                    </span>
                  ) : (
        ...
        <div className='border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3'>
          ...
          <div className='flex flex-wrap justify-center gap-4'>
            <a
              ...
              className='font-body text-brand-mid-gray text-xs hover:text-white transition-colors'>
