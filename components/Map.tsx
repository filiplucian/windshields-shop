export default function Map() {
  const gmapsEmbed =
    'https://maps.google.com/maps?q=Centrul+de+Parbrize+Badilita+Radauti&hl=ro&z=17&t=h&output=embed'
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8'>
          ...
          <div
            ...
            <iframe
              ...
              title='Harta satelit Centru de Parbrize Bădiliță – str. Ștefan cel Mare 129, Rădăuți'
            />
          </div>
          ...
          <div className='card flex flex-col gap-5'>
            ...
            <div className='space-y-4 flex-1'>
              ...
              <div className='flex gap-3'>
                ...
                <div>
                  ...
                  <a
                    ...
                    className='block font-body text-brand-mid-gray text-sm hover:text-white transition-colors'>
                    0754 760 568
                  </a>
                  <a
              ...
              <p className='font-body text-brand-mid-gray/60 text-xs italic'>
                💡 În hartă poți comuta între vedere stradă și satelit folosind
                butonul din colțul hărții.
              </p>
            </div>
