...
export default function Header() {
  ...
  return (
    <>
      {/* Checkbox ascuns – controlează meniul prin CSS peer, fără JS necesar */}
      <input
        type="checkbox"
        id="nav-toggle"
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-brand-black border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-13">
            ...
            {/* Logo */}
            <a href="#" className="flex items-center shrink-0 min-w-0 py-2" aria-label="Centru de Parbrize Bădiliță">
              <BrandLogo size="sm" />
            </a>
      ...
      >
        ...
        <div className="flex justify-end px-4 pt-4">
          <label
            htmlFor="nav-toggle"
            className="flex items-center justify-center w-10 h-10 text-white cursor-pointer touch-manipulation"
            onClick={closeMenu}
